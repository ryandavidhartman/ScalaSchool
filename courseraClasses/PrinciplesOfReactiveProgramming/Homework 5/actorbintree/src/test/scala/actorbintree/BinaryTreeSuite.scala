...
import actorbintree.BinaryTreeNode.InsertNode
import actorbintree.BinaryTreeNode.CopyTo
import actorbintree.BinaryTreeNode.ContainsNode
...
class BinaryTreeSuite(_system: ActorSystem) extends TestKit(_system) with FunSuite with ShouldMatchers with BeforeAndAfterAll with ImplicitSender {
  ...
  test("should copy to properly") {
//    val topNode = system.actorOf(Props[BinaryTreeNode])
//    val newNode = system.actorOf(Props[BinaryTreeNode])
//    
//    topNode ! InsertNode(testActor, id = 1, 1)
//    topNode ! InsertNode(testActor, id = 2, 3)
//    topNode ! InsertNode(testActor, id = 3, 2)
//    
//    topNode ! ContainsNode(1)
//    expectMsg(true)
//    
//    topNode ! ContainsNode(1)
//    expectMsg(true)
...
//    expectMsg(true)
//    
////    topNode ! CopyTo(newNode)
////    newNode ! ContainsNode(1)
////    expectMsg(true)
////    
////    newNode ! ContainsNode(1)
////    expectMsg(true)
